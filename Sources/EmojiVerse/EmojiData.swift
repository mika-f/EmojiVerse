...
public struct EmojiData {
  ...
  /// デフォルトのカテゴリーを取得
  public static func getDefaultCategories() -> [EmojiCategory] {
    // キャッシュがあればそれを返す
  ...
  /// 指定されたカテゴリータイプのみを取得
  public static func getCategories(types: [EmojiCategoryType]) -> [EmojiCategory] {
  ...
  /// 最近使用した絵文字のカテゴリーを取得
  public static func getFrequencyCategory() -> EmojiCategory? {
  ...
  public static func getCategoriesWithFrequency() -> [EmojiCategory] {
